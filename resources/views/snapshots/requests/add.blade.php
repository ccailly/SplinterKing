                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('snapshots.requests.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                <label class="text-gray-700" for="account">Compte</label>
                            ...
                            <div>
                                <label class="text-gray-700" for="priority">Priorité</label>
                        ...
                        <div class="flex justify-end mt-6">
                            <button
                                class="px-8 py-2.5 leading-5 text-gray-700 transition-colors duration-200 bg-white border rounded-lg sm:w-auto  hover:bg-gray-100">Enregistrer</button>
                        </div>
                    </form>
                </div>
            </div>
