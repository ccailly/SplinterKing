            ...
            <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
                ...
                <div class="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
                    <a href="{{ route('drops.index') }}"
                        class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0  hover:bg-gray-100 @if (Route::currentRouteName() == 'drops.index') bg-gray-100 @endif">
                        Drops
                    </a>
                    ...
                    <a href="{{ route('ranking.shows') }}"
                        class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0  hover:bg-gray-100 @if (Route::currentRouteName() == 'ranking.shows') bg-gray-100 @endif">
                        Classements
                    </a>
                </div>
